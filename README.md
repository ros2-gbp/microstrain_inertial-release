## microstrain_inertial (rolling) - 4.9.0-1

The packages in the `microstrain_inertial` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling --no-web --non-interactive microstrain_inertial` on `Tue, 09 Jun 2026 19:07:31 -0000`
...
## microstrain_inertial (humble) - 4.9.0-1

The packages in the `microstrain_inertial` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble --no-web --non-interactive microstrain_inertial` on `Tue, 09 Jun 2026 18:43:40 -0000`
...
## microstrain_inertial (rolling) - 4.8.0-1

The packages in the `microstrain_inertial` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling --no-web --non-interactive microstrain_inertial` on `Wed, 22 Oct 2025 19:03:18 -0000`
...
## microstrain_inertial (kilted) - 4.8.0-1

The packages in the `microstrain_inertial` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --ros-distro kilted --no-web --non-interactive microstrain_inertial` on `Wed, 22 Oct 2025 18:58:54 -0000`
...
## microstrain_inertial (jazzy) - 4.8.0-1

The packages in the `microstrain_inertial` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy --no-web --non-interactive microstrain_inertial` on `Wed, 22 Oct 2025 18:54:33 -0000`
...
## microstrain_inertial (humble) - 4.8.0-1

The packages in the `microstrain_inertial` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble --no-web --non-interactive microstrain_inertial` on `Wed, 22 Oct 2025 18:50:27 -0000`
...
## microstrain_inertial (rolling) - 4.7.0-1

The packages in the `microstrain_inertial` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling --no-web --non-interactive microstrain_inertial` on `Thu, 05 Jun 2025 15:08:27 -0000`
...
## microstrain_inertial (kilted) - 4.7.0-1

The packages in the `microstrain_inertial` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --ros-distro kilted --no-web --non-interactive microstrain_inertial` on `Thu, 05 Jun 2025 15:05:05 -0000`
...
The packages in the `microstrain_inertial` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy --no-web --non-interactive microstrain_inertial` on `Thu, 05 Jun 2025 15:01:34 -0000`
...
The packages in the `microstrain_inertial` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble --no-web --non-interactive microstrain_inertial` on `Thu, 05 Jun 2025 14:58:01 -0000`
...
## microstrain_inertial (rolling) - 4.6.1-1

The packages in the `microstrain_inertial` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling --no-web --non-interactive microstrain_inertial` on `Fri, 25 Apr 2025 14:12:37 -0000`
...
## microstrain_inertial (jazzy) - 4.6.1-1

The packages in the `microstrain_inertial` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy --no-web --non-interactive microstrain_inertial` on `Fri, 25 Apr 2025 14:08:45 -0000`
...
## microstrain_inertial (humble) - 4.6.1-1

The packages in the `microstrain_inertial` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble --no-web --non-interactive microstrain_inertial` on `Fri, 25 Apr 2025 14:05:17 -0000`
...
## microstrain_inertial (rolling) - 4.6.0-1

The packages in the `microstrain_inertial` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling --no-web --non-interactive microstrain_inertial` on `Tue, 15 Apr 2025 14:54:31 -0000`
...
## microstrain_inertial (jazzy) - 4.6.0-1

The packages in the `microstrain_inertial` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy --no-web --non-interactive microstrain_inertial` on `Tue, 15 Apr 2025 14:51:05 -0000`
...
## microstrain_inertial (humble) - 4.6.0-1
