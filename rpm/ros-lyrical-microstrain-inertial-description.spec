...
%global pkg_name microstrain_inertial_description
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-microstrain-inertial-description
Version:        4.8.0
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Rob Fisher <rob.fisher@parker.com> - 4.8.0-3
